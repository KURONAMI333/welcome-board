...
public final class DisplayQueueController {
     ...
     * mc.gui.screen() instanceof WelcomeBoardScreen}: once showing has started, a player clicking a URL
    ...
    public static void onClientTick() {
        ...
        DisplayTrigger.Decision decision = DisplayTrigger.decide(ticksSinceJoin, minecraft.gui.screen() != null);
        switch (decision) {
    ...
    private static void showNextOrFinish(Minecraft minecraft) {
        ...
        minecraft.gui.setScreen(new WelcomeBoardScreen(next.content(), () -> onScreenClosed(next)));
    }
