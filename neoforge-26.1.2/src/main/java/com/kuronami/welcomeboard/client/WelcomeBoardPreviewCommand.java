...
public final class WelcomeBoardPreviewCommand {
    ...
    private static int preview(CommandSourceStack source) {
        ...
        // setScreen(null) right after handleChatInput() returns (see ChatScreen#keyPressed), on
        ...
        minecraft.schedule(() -> minecraft.setScreen(new WelcomeBoardScreen(content, null)));
